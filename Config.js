...
const APP_CHANGELOG = [
  {
    ...
    date: '2026-06-08',
    changes: [
      'Srovnání výšky a zarovnání checkboxu, nadpisu a šipek řazení v prvním sloupci tabulky prodejen',
    ],
  },
  {
    version: 'v0.29.5',
    date: '2026-06-08',
    changes: [
      'Řazení RM v rozevíracím seznamu: nejdříve RM odpovídající filtrům abecedně, poté ostatní',
    ],
  },
  {
    version: 'v0.29.4',
    date: '2026-06-08',
    changes: [
      'Oprava porovnávání časů otevírací doby a oprava zobrazení historie synchronizací v UI',
    ],
  },
  {
    version: 'v0.29.3',
  ...
  },
  {
    ...
    date: '2026-06-08',
    changes: [
      'Opravena chyba s nečitelným formátem datumu při serializaci historie synchronizací',
    ],
  },
  {
    version: 'v0.29.1',
  ...
  },
  {
    ...
    date: '2026-06-08',
    changes: [
      'Implementován podrobný audit změn a historie synchronizací filiálek',
    ],
  },
  {
    version: 'v0.28.2',
    date: '2026-06-08',
    changes: [
      'Opravena ReferenceError props v synchronizačním skriptu',
    ],
  },
  {
    version: 'v0.28.1',
    date: '2026-06-08',
    changes: [
      'Přidáno chybějící oprávnění pro UrlFetchApp (externí požadavky)',
    ],
  },
  {
    version: 'v0.28.0',
    date: '2026-06-08',
    changes: [
      'Přesunuto ukládání nastavení synchronizace filiálek do databázového listu CONFIG',
      'Předělána podzáložka Synchronizace do čtyř modulů s možností pohodlné editace',
    ],
  },
  {
    version: 'v0.27.0',
    date: '2026-06-08',
    changes: [
      'Přepracována záložka Synchronizace — přidány karty s otevřením složek a inline editací',
    ],
  },
  {
    version: 'v0.26.0',
    date: '2026-06-08',
    changes: [
      'Přidána podpora pro synchronizaci filiálek z Excel (.xlsx) souborů',
    ],
  },
  {
    version: 'v0.25.3',
    date: '2026-06-08',
    changes: [
      'Odstraněn žlutý stín pod primárními tlačítky v celé aplikaci',
    ],
  },
  {
    version: 'v0.25.2',
  ...
  },
  {
    ...
    date: '2026-06-08',
    changes: [
      'Lišta hromadných akcí filiálek změněna na plovoucí banner',
    ],
  },
  {
    version: 'v0.25.0',
  ...
  },
  {
    ...
    date: '2026-06-08',
    changes: [
      'Synchronizace přesunuta jako záložka do sekce LC a filiálky',
      'Odstraněna samostatná položka Umístění — logistická centra se spravují v přehledu LC a filiálky',
    ],
  },
  {
    version: 'v0.23.0',
    date: '2026-06-08',
    changes: [
      'Sloučeny položky Umístění a Sync LC a filiálek do jediné sekce „Správa LC a filiálek" se záložkami',
      'Umístění a synchronizace filiálek jsou nyní dostupné na jednom místě',
    ],
  },
  {
    version: 'v0.22.2',
    date: '2026-06-02',
    changes: [
      'Ikony nyni vertikalne vycentrovane',
      'Checkbox a cislo filialky vedle sebe',
      'Tlacitka Aktivovat/Deaktivovat maji ikony',
    ],
  },
  {
    version: 'v0.22.1',
    date: '2026-06-02',
    changes: [
      'Opraveno centrovani ikon (inline-grid)',
      'Opravena velikost checkboxu u filialek',
      'Opraveno necitelne tlacitko Deaktivovat',
    ],
  },
  {
    version: 'v0.22.0',
    date: '2026-06-02',
    changes: [
      'Pridana hromadna aktivace/deaktivace filialek (checkboxy ve sloupci Cislo + lista akci)',
      'Neaktivni filialky se beznym uzivatelum ve frontendu nenacitaji',
      'Deaktivace filialek zustava zachovana i po synchronizaci',
    ],
  },
  {
    version: 'v0.21.1',
    date: '2026-06-02',
    changes: [
      'Opraveno centrovani ikon v kartach dashboardu a dlazdicich modulu',
    ],
  },
  {
    version: 'v0.21.0',
  ...
  },
  {
    ...
    date: '2026-06-02',
    changes: [
      'Zpevneno centrovani ikon v dlazdicich modulu',
    ],
  },
  {
    version: 'v0.20.3',
    date: '2026-06-02',
    changes: [
      'Opraveno nenacteni dashboardu zpusobene odesilanim data posledni navstevy v nepodporovanem formatu',
    ],
  },
  {
    version: 'v0.20.2',
  ...
  },
  {
    ...
    date: '2026-06-02',
    changes: [
      'Opraveno ukotveni paticky na dolni okraj na ploche dashboardu',
    ],
  },
  {
    version: 'v0.20.0',
