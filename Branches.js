...
function mapBranchRow_(row) {
  return {
    ...
    mondayOpen: String(row.mondayOpen || ''),
    mondayClose: String(row.mondayClose || ''),
    tuesdayOpen: String(row.tuesdayOpen || ''),
    tuesdayClose: String(row.tuesdayClose || ''),
    wednesdayOpen: String(row.wednesdayOpen || ''),
    wednesdayClose: String(row.wednesdayClose || ''),
    thursdayOpen: String(row.thursdayOpen || ''),
    thursdayClose: String(row.thursdayClose || ''),
    fridayOpen: String(row.fridayOpen || ''),
    fridayClose: String(row.fridayClose || ''),
    saturdayOpen: String(row.saturdayOpen || ''),
    saturdayClose: String(row.saturdayClose || ''),
    sundayOpen: String(row.sundayOpen || ''),
    sundayClose: String(row.sundayClose || ''),
